...
██ ███ ██ ██  ███    ██ ███ ██ ██  ███         ██ ██  ██    ██ ██ 
 ███ ███  ██ ███████  ███ ███  ██ ███████     ██   ██  ██████  ██ 
\033[0m"
echo -e "    \e[31mTelegram Channel: \e[34my_usern\033[0m | \e[31mTelegram Group: \e[34m@my_usern\033[0m\n"
...
git clone https://github.com/NEOALPHA1/PNL.git /var/www/html/wizwizxui-timebot
...
wait
    ...
    if [[ $(mysql -u root -p$ROOT_PASSWORD -e "SHOW DATABASES LIKE 'wizwiz'") ]]; then
        ...
        MESSAGE="✅ The NIN bot has been successfully installed! @my_usern"
